  ...
  return (
    <div class="control-panel-root">
      ...
      <div class="scroll-to-top-dock">
        ...
        <button id="btn-scroll-top" class="dock-btn" title="أعلى الصفحة" data-lang-en-title="Top of Page">
      ...
      {fileData.slug !== "index" && (
        <div class="back-to-prev-dock">
          <button id="btn-back" class="dock-btn" title="رجوع للصفحة السابقة" data-lang-en-title="Go Back">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      {fileData.slug !== "index" && !fileData.slug?.endsWith("index") && !fileData.slug?.startsWith("tags/") && (
        <>
          <div class="isolated-gear-dock">
            <button id="btn-settings-toggle" class="dock-btn" title="إعدادات القراءة" data-lang-en-title="Reading Settings">
          ...
          <div class="control-group">
            <span class="control-label" data-lang-en="Font Size">حجم الخط</span>
            <div class="control-buttons">
              <button id="btn-font-large" class="ctrl-btn" title="خط كبير">
                ...
                <span class="btn-text" data-lang-en="Large">كبير</span>
              </button>
              <button id="btn-font-medium" class="ctrl-btn active" title="خط متوسط">
                ...
                <span class="btn-text" data-lang-en="Medium">متوسط</span>
              </button>
              <button id="btn-font-small" class="ctrl-btn" title="خط صغير">
                ...
                <span class="btn-text" data-lang-en="Small">صغير</span>
              </button>
            </div>
          </div>
          ...
          {/* Line Height Control */}
          <div class="control-group">
            <span class="control-label" data-lang-en="Line Height">ارتفاع السطر</span>
            <div class="control-buttons">
              <button id="btn-line-large" class="ctrl-btn" title="واسع">
                ...
                <span class="btn-text" data-lang-en="Wide">واسع</span>
              </button>
              ...
              <button id="btn-line-small" class="ctrl-btn" title="ضيق">
                ...
                <span class="btn-text" data-lang-en="Narrow">ضيق</span>
              </button>
            </div>
          </div>
          ...
          <div class="control-group">
            <span class="control-label" data-lang-en="Reading Width">عرض القراءة</span>
            <div class="control-buttons">
              <button id="btn-width-wide" class="ctrl-btn" title="عريض">
                <span class="btn-text-only" data-lang-en="Wide">عريض</span>
              </button>
              <button id="btn-width-medium" class="ctrl-btn active" title="متوسط">
                <span class="btn-text-only" data-lang-en="Medium">متوسط</span>
              </button>
              <button id="btn-width-narrow" class="ctrl-btn" title="ضيق">
                <span class="btn-text-only" data-lang-en="Narrow">ضيق</span>
              </button>
            </div>
          </div>
          ...
          <div class="control-group toggles-list">
            <div class="toggle-row">
              <span class="toggle-label" data-lang-en="Audio">الصوت</span>
            ...
            <div class="toggle-row">
              <span class="toggle-label" data-lang-en="TOC">الفهرس</span>
              <button id="btn-toggle-toc" class="small-action-btn" title="تفعيل / إيقاف الفهرس">
                <span>فتح</span>
              </button>
            </div>
            <div class="toggle-row">
              <span class="toggle-label" data-lang-en="Bookmarks">الإشارات</span>
        ...
        <div id="bookmarks-sidebar" class="bookmarks-sidebar sidebar-hidden">
          <div class="bookmarks-header">
            <h3 class="control-label" data-lang-en="Bookmarks">الإشارات المرجعية</h3>
          ...
          <div id="bookmarks-container" class="bookmarks-list">
            <div class="empty-bookmarks" data-lang-en="No bookmarks yet. You can save any paragraph while reading.">لا توجد علامات مرجعية بعد. يمكنك حفظ أي فقرة عند القراءة.</div>
          </div>
        </div>
